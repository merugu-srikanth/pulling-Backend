...
import { getWebsites, addWebsite, deleteWebsite, uploadWebsites, updateWebsite, deleteAllWebsites } from "../controllers/website.controller";
...
router.delete("/websites", deleteAllWebsites);
